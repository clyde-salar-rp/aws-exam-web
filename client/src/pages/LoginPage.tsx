    ...
    <div className="flex min-h-screen items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-md space-y-8">
        ...
        <div className="flex flex-col space-y-2 text-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight">AWS Exam Prep</h1>
          <p className="text-sm text-muted-foreground">
            Sign in to track your progress and exam history
          </p>
        </div>
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login" className="space-y-4 mt-4">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full border-blue-200 hover:border-blue-300 hover:bg-blue-50 dark:border-blue-800 dark:hover:border-blue-700 dark:hover:bg-blue-950/50"
                  disabled={loading}
                >
